...
CATALOG = [
    ...
    ("enc-corner-sq-dblbifold", "Corner Enclosure — Double Bi-Fold Door", "showering/shower-enclosures", 900, 1900, 900, CHROME_SET),
    ("enc-corner-rnd-sliding", "Corner Enclosure Rounded — Sliding Door", "showering/shower-enclosures", 900, 1900, 900, CHROME_SET),
    ("enc-corner-rnd-dsliding", "Corner Enclosure Rounded — Double Sliding Door", "showering/shower-enclosures", 900, 1900, 900, CHROME_SET),
    ("enc-corner-rnd-bifold", "Corner Enclosure Rounded — Bi-Fold Door", "showering/shower-enclosures", 900, 1900, 900, CHROME_SET),
    ("enc-corner-rnd-dblbifold", "Corner Enclosure Rounded — Double Bi-Fold Door", "showering/shower-enclosures", 900, 1900, 900, CHROME_SET),
    ("enc-corner-rnd-open", "Corner Enclosure Rounded — Open", "showering/shower-enclosures", 900, 1900, 900, CHROME_SET),
    ("enc-corner-rnd-panel", "Corner Enclosure Rounded — Single Fixed Panel", "showering/shower-enclosures", 900, 1900, 900, CHROME_SET),
    ("enc-quadrant-dsliding", "Quadrant Enclosure — Double Sliding Door", "showering/shower-enclosures", 900, 1900, 900, CHROME_SET),
    ("enc-quadrant-dblbifold", "Quadrant Enclosure — Double Bi-Fold Door", "showering/shower-enclosures", 900, 1900, 900, CHROME_SET),
    ("enc-quadrant-panel", "Quadrant Enclosure — Single Fixed Panel", "showering/shower-enclosures", 900, 1900, 900, CHROME_SET),
    ("enc-midwall-fold", "Mid-Wall Enclosure — Bi-Fold Door", "showering/shower-enclosures", 1200, 1900, 900, CHROME_SET),
    ("enc-midwall-dsliding", "Mid-Wall Enclosure — Double Sliding Door", "showering/shower-enclosures", 1200, 1900, 900, CHROME_SET),
    ("enc-midwall-panel", "Mid-Wall Enclosure — Single Fixed Panel", "showering/shower-enclosures", 1200, 1900, 900, CHROME_SET),
    ("enc-dooronly-dsliding", "Door Only — Double Sliding", "showering/shower-enclosures", 900, 1900, 50, CHROME_SET),
    ("enc-dooronly-panel", "Door Only — Fixed Panel", "showering/shower-enclosures", 900, 1900, 50, CHROME_SET),
    # --- trays (3) ---
    ...
    ("tray-sq-curved1", "Square Tray — Curved Single Corner", "showering/shower-trays", 900, 45, 900, WHITE_SET),
    ("tray-sq-curved2", "Square Tray — Curved Double Corner", "showering/shower-trays", 900, 45, 900, WHITE_SET),
    ("tray-sq-waste-corner", "Square Tray — Corner Waste", "showering/shower-trays", 900, 45, 900, WHITE_SET),
    ("tray-sq-waste-edge", "Square Tray — Middle Edge Waste", "showering/shower-trays", 900, 45, 900, WHITE_SET),
    ("tray-rect-curved1", "Rectangular Tray — Curved Single Corner", "showering/shower-trays", 1200, 45, 800, WHITE_SET),
    ("tray-rect-curved2", "Rectangular Tray — Curved Double Corner", "showering/shower-trays", 1200, 45, 800, WHITE_SET),
    ("tray-rect-waste-corner", "Rectangular Tray — Corner Waste", "showering/shower-trays", 1200, 45, 800, WHITE_SET),
    ("tray-rect-waste-edge", "Rectangular Tray — Middle Edge Waste", "showering/shower-trays", 1200, 45, 800, WHITE_SET),
    # --- toilets (6) ---
    ...
    ("vanity-standing-1drawer", "Standing Vanity — 1 Drawer", "furniture/vanity-units", 600, 850, 460, OAK_SET),
    ("vanity-standing-3drawer", "Standing Vanity — 3 Drawer", "furniture/vanity-units", 800, 850, 460, OAK_SET),
    ("vanity-standing-4drawer", "Standing Vanity — 4 Drawer", "furniture/vanity-units", 900, 850, 460, OAK_SET),
    ("vanity-floating-1drawer", "Floating Vanity — 1 Drawer", "furniture/vanity-units", 600, 500, 460, OAK_SET),
    ("vanity-floating-3drawer", "Floating Vanity — 3 Drawer", "furniture/vanity-units", 800, 600, 460, OAK_SET),
    ("vanity-floating-4drawer", "Floating Vanity — 4 Drawer", "furniture/vanity-units", 900, 650, 460, OAK_SET),
    ...
    ("mirror-oval-led", "Oval Mirror — LED Margin Border", "mirrors-cabinets/mirrors", 500, 800, 22, CHROME_SET),
    ("mirror-square", "Square Mirror", "mirrors-cabinets/mirrors", 550, 550, 20, CHROME_SET),
    ("mirror-square-rounded", "Square Mirror — Rounded Corners", "mirrors-cabinets/mirrors", 550, 550, 20, CHROME_SET),
    ("mirror-rect-led-margin", "Rectangle Mirror — LED Margin Border", "mirrors-cabinets/mirrors", 600, 800, 22, CHROME_SET),
    ("mirror-rect-led-sides", "Rectangle Mirror — LED Sides Only", "mirrors-cabinets/mirrors", 600, 800, 22, CHROME_SET),
    ("mirror-square-led-edge", "Square Mirror — LED Edge", "mirrors-cabinets/mirrors", 550, 550, 22, CHROME_SET),
    ("mirror-square-led-margin", "Square Mirror — LED Margin Border", "mirrors-cabinets/mirrors", 550, 550, 22, CHROME_SET),
    ("mirror-square-led-sides", "Square Mirror — LED Sides Only", "mirrors-cabinets/mirrors", 550, 550, 22, CHROME_SET),
    ("mirror-round-led-margin", "Round Mirror — LED Margin Border", "mirrors-cabinets/mirrors", 600, 600, 22, CHROME_SET),
    ("mirror-oval-led-edge", "Oval Mirror — LED Edge", "mirrors-cabinets/mirrors", 500, 800, 22, CHROME_SET),
    ("mirror-oval-led-sides", "Oval Mirror — LED Sides Only", "mirrors-cabinets/mirrors", 500, 800, 22, CHROME_SET),
